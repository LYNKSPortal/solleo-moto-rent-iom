...
export default function Contact() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    alert(`Thank you for contacting us, ${formData.name}! We'll get back to you shortly.`);
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-lg shadow-lg p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full bg-yellow-400 text-blue-700 font-bold py-3 px-6 rounded-md hover:bg-yellow-500 transition-colors"
                >
                  Send Message
                </button>
              </form>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-lg p-6">
              <div className="flex items-start mb-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">support@solleomotorent.com</p>
            ...
            <div className="bg-white rounded-lg shadow-lg p-6">
              <div className="flex items-start mb-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-blue-700 mb-1">Location</h3>
                  <p className="text-gray-600">Pasaje Colina del Mirador 19, Unit 4</p>
                  <p className="text-gray-600">29680 Estepona, Málaga</p>
                  <p className="text-gray-600">Spain</p>
                </div>
              </div>
            </div>

            <div className="bg-blue-700 text-white rounded-lg shadow-lg p-6">
